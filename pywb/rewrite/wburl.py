...
class BaseWbUrl(object):
    ...
    def is_continuity(self):
        return self.is_continuity_type(self.type)
    ...
    @staticmethod
    def is_continuity_type(type_):
        return type_ == BaseWbUrl.CONTINUITY
...
class WbUrl(BaseWbUrl):
    ...
    def to_wburl_str(url, type=BaseWbUrl.LATEST_REPLAY,
        ...
        elif WbUrl.is_continuity_type(type):
            return '+/' + url
